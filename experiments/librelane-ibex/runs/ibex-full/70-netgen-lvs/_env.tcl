...
set ::env(NETGEN_SETUP) /opt/pdks/sky130A/libs.tech/netgen/sky130A_setup.tcl
set ::env(LVS_INCLUDE_MARCO_NETLISTS) 0
set ::env(CURRENT_SPICE) /home/designer/shared/chipus-soc/mini-SoC/experiments/librelane-ibex/runs/ibex-full/68-magic-spiceextraction/chipus_ibex_wrapper.spice
set ::env(CURRENT_PNL) /home/designer/shared/chipus-soc/mini-SoC/experiments/librelane-ibex/runs/ibex-full/52-openroad-fillinsertion/chipus_ibex_wrapper.pnl.v
