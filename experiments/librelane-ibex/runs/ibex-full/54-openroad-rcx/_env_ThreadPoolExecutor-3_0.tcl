...
set ::env(RCX_RULESETS) "\"nom_*\" /opt/pdks/sky130A/libs.tech/openlane/rules.openrcx.sky130A.nom.calibre \"min_*\" /opt/pdks/sky130A/libs.tech/openlane/rules.openrcx.sky130A.min.calibre \"max_*\" /opt/pdks/sky130A/libs.tech/openlane/rules.openrcx.sky130A.max.calibre"
set ::env(CURRENT_DEF) /home/designer/shared/chipus-soc/mini-SoC/experiments/librelane-ibex/runs/ibex-full/53-odb-cellfrequencytables/chipus_ibex_wrapper.def
set ::env(RCX_LEF) /opt/pdks/sky130A/libs.ref/sky130_fd_sc_hd/techlef/sky130_fd_sc_hd__nom.tlef
set ::env(RCX_RULESET) /opt/pdks/sky130A/libs.tech/openlane/rules.openrcx.sky130A.nom.calibre
set ::env(SAVE_SPEF) /home/designer/shared/chipus-soc/mini-SoC/experiments/librelane-ibex/runs/ibex-full/54-openroad-rcx/nom/chipus_ibex_wrapper.nom.spef
