...
set ::env(RCX_LEF) /opt/pdks/sky130A/libs.ref/sky130_fd_sc_hd/techlef/sky130_fd_sc_hd__max.tlef
set ::env(RCX_RULESET) /opt/pdks/sky130A/libs.tech/openlane/rules.openrcx.sky130A.max.calibre
set ::env(SAVE_SPEF) /home/designer/shared/chipus-soc/mini-SoC/experiments/librelane-ibex/runs/ibex-full/54-openroad-rcx/max/chipus_ibex_wrapper.max.spef
