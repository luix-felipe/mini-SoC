set ::env(TRACKS_INFO_FILE_PROCESSED) /home/designer/shared/chipus-soc/mini-SoC/experiments/librelane-ibex/runs/ibex-detailed-placement/13-openroad-floorplan/config.tracks
...
set ::env(FP_TRACKS_INFO) /opt/pdks/sky130A/libs.tech/openlane/sky130_fd_sc_hd/tracks.info
...
set ::env(CURRENT_NL) /home/designer/shared/chipus-soc/mini-SoC/experiments/librelane-ibex/runs/ibex-detailed-placement/06-yosys-synthesis/chipus_ibex_wrapper.nl.v
set ::env(SAVE_ODB) /home/designer/shared/chipus-soc/mini-SoC/experiments/librelane-ibex/runs/ibex-detailed-placement/13-openroad-floorplan/chipus_ibex_wrapper.odb
set ::env(SAVE_DEF) /home/designer/shared/chipus-soc/mini-SoC/experiments/librelane-ibex/runs/ibex-detailed-placement/13-openroad-floorplan/chipus_ibex_wrapper.def
set ::env(SAVE_SDC) /home/designer/shared/chipus-soc/mini-SoC/experiments/librelane-ibex/runs/ibex-detailed-placement/13-openroad-floorplan/chipus_ibex_wrapper.sdc
set ::env(SAVE_NL) /home/designer/shared/chipus-soc/mini-SoC/experiments/librelane-ibex/runs/ibex-detailed-placement/13-openroad-floorplan/chipus_ibex_wrapper.nl.v
set ::env(SAVE_PNL) /home/designer/shared/chipus-soc/mini-SoC/experiments/librelane-ibex/runs/ibex-detailed-placement/13-openroad-floorplan/chipus_ibex_wrapper.pnl.v
