...
| [`librelane-ibex`](librelane-ibex/README.md) | `CANDIDATE` (fluxo parcial) | Ibex isolado sintetizado e posicionado; pausa antes do CTS; routing/GDSII e checks finais `UNTESTED` |
